...
@Component({
  selector: 'app-inspection-reg-cci',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, NgSelectModule],
  templateUrl: './inspection-reg-cci.component.html',
  styleUrl: './inspection-reg-cci.component.css'
})
export class InspectionRegCciComponent implements OnInit {
