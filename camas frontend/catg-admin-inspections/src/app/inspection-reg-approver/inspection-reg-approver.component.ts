...
@Component({
  selector: 'app-inspection-reg-approver',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, NgSelectModule],
  templateUrl: './inspection-reg-approver.component.html',
  styleUrl: './inspection-reg-approver.component.css'
})
export class InspectionRegApproverComponent implements OnInit {
