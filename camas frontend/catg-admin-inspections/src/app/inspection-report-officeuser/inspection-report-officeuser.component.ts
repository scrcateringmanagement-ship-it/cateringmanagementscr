...
@Component({
  selector: 'app-inspection-report-officeuser',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './inspection-report-officeuser.component.html',
  styleUrl: './inspection-report-officeuser.component.css'
})
export class InspectionReportOfficeuserComponent implements OnInit {
  inspections: any[] = [];
  fromDate: string = '';
  toDate: string = '';
  ...
  fetchInspections() {
    ...
    this.apicall.getInspectionsReportOfficeUser(params).subscribe({
      next: (res: any) => {
